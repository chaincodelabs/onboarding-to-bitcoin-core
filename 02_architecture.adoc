...
....
flowchart LR
    base_request["BaseRequestHandler()"]
    connect_call["ConnectAndCallRPC()"]
    addr_request["AddrInfoRequestHandler()"]
    get_info["GetInfoRequestHandler()"]
    net_info["NetInfoRequestHandler()"]
    generate["GenerateToAddressHandler()"]
    default["DefaultRequestHandler()"]

    base_request --> addr_request --> connect_call
    base_request --> get_info --> connect_call
    base_request --> net_info --> connect_call
    base_request --> generate --> connect_call
    base_request --> default --> connect_call
    connect_call <---> bitcoin-cli
