...
Review of the architecture of Bitcoin Core from the previous weeks' material will naturally lead to a region in the project titled https://github.com/chaincodelabs/bitcoin-core-onboarding/tree/main/1.1_regions.asciidoc#consensus_region["consensus/"] which one might conclude contains *all* the logic for maintaining consensus.
...
This was executed in https://github.com/bitcoin/bitcoin/pull/2520[PR 2520].
