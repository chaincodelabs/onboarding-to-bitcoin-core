...
|---------------------------|--------------------------------|-------------------------------|---------------------------------------|
| Mining algorithm          | Public hashing with difficulty | Local hashing, low difficulty | Signature from authorised signers     |
...
Being assigned a BIP does not mean that an idea is endorsed as being a "good" idea, only that it is fully well-specified in a way that others could use to re-implement.
