...
Carl Dong gave an introduction to GUIX via a https://btctranscripts.com/breaking-bitcoin/2019/bitcoin-build-system/[remote talk^] in 2019, and also discussed it further on a ChainCode https://www.youtube.com/watch?v=Y5Gfli3x6rI[podcast^] episode.
