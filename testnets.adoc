...
$ build/bin/bitcoind -regtest -datadir=/tmp/regtest-datadir
$ build/bin/bitcoin-cli -regtest -datadir=/tmp/regtest-datadir getblockchaininfo
{
  "chain": "regtest",
  "blocks": 0,
  "headers": 0,
...
$ build/bin/bitcoin-cli -regtest -datadir=/tmp/regtest-datadir createwallet testwallet
$ build/bin/bitcoin-cli -regtest -datadir=/tmp/regtest-datadir -generate 3
{
...
$ build/bin/bitcoin-cli -regtest -datadir=/tmp/regtest-datadir getbalances
{
  "mine": {
    "trusted": 0.00000000,
...
$ build/bin/bitcoin-cli -regtest -datadir=/tmp/regtest-datadir stop
----
