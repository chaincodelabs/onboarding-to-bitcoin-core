...
Note that `SetupEnvironment` is a common function and is called from all major components:
...
Since writing this documentation (at commit https://github.com/bitcoin/bitcoin/tree/4b5659c6b115315c9fd2902b4edd4b960a5e066e[4b5659c6]) much focus has been put on re-writing the Qt code leveraging the https://doc.qt.io/qt-5/qtqml-index.html[Qt QML] framework.
